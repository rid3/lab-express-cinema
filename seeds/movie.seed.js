const movies = [
  ...
  //conecto con el Model para armar la cosa
  const Movie = require ("../models/Movie.model") 

 //acá conecto con mongoose para pasar la data
...
.then ((response) => {
console.log("ya conectadito a la bd")

//mando el array de movies mediante el Model a la base de datos que ya se creó
return Movie.insertMany(movies)
})
.then ((response) => {
  //console.log("ya info en bd")
